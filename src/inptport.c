...
/* nothing in the vendored tree defines this (likely dropped during some
   upstream refactor) - real storage here since this is the only file that
   references it. */
bool save_protection = false;
