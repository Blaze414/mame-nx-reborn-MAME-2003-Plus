...
static INLINE void get_bg_tile_info(int tile_index,int gfx_bank,UINT16 *gfx_base)
{
...
static INLINE void get_fncywld_bg_tile_info(int tile_index,int gfx_bank,UINT16 *gfx_base)
{
