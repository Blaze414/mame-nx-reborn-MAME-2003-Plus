...
/* declared extern in machine/system16.c and used by drivers/system16.c,
   but nothing in the vendored tree defines them - real storage here
   (this file, not the uncompiled vidhrdw/system16_vidhrdw.c). */
int sys16_wwfix;
int sys16_alienfix;
