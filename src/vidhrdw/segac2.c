...
/* EXTERNALLY ACCESSIBLE */
       ...
       UINT16		scanbase;					/* declared extern in drivers/segac2.c, real storage only existed in the uncompiled vidhrdw/segac2_vidhrdw.c */
...
/* System 18 shares the C2 VDP. Ported from the newer segac2_vidhrdw.c, minus its
   pal_offs / per-line transparent-pen arguments, which this older drawline lacks. */
...
/* megaplay: Genesis screen with the SMS bios menu drawn over the top */
