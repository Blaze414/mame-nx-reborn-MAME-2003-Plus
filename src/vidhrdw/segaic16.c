...
/* Read accessors for the three shared RAM regions. Upstream keeps these in
   drivers/segas16b.c, but this port builds drivers/system16.c instead, so they
   live here next to the arrays they index. */
READ16_HANDLER( segaic16_textram_r )   { return segaic16_textram_0[offset]; }
READ16_HANDLER( segaic16_tileram_r )   { return segaic16_tileram_0[offset]; }
READ16_HANDLER( segaic16_spriteram_r ) { return segaic16_spriteram_0[offset]; }
