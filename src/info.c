...
/*		"\t\t<!ELEMENT driver (#PCDATA)>\n" */
	...
	/* BIOS "resource" pseudo-drivers are not emitted: this port links a
	   trimmed driver set, so most of these driver_* symbols do not exist.
	   The XML lister is not reachable from the Switch frontend anyway. */
