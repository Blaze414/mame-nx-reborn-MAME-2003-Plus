...
/* hdcomp.c (host-side CHD conversion tool) wants this for error messages;
   hard_disk_open()/etc here don't track a specific failure reason, so this
   always reports "no error" rather than fabricate one. */
