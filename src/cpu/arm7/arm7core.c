...
static INLINE void HandleBranch( data32_t insn);       //pretty short, so inline should be ok
...
static INLINE void arm7_cpu_write32( int addr, data32_t data );
static INLINE void arm7_cpu_write16( int addr, data16_t data );
static INLINE void arm7_cpu_write8( int addr, data8_t data );
static INLINE data32_t arm7_cpu_read32( int addr );
static INLINE data16_t arm7_cpu_read16( int addr );
static INLINE data8_t arm7_cpu_read8( offs_t addr );
...
static INLINE void SwitchMode (int cpsr_mode_val)
{
