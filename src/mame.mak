...
$(OBJ)/pacman.a: \
	...
	$(OBJ)/vidhrdw/pacman_vidhrdw.o $(OBJ)/drivers/pengo.o \
...
$(OBJ)/namco.a: \
	...
	$(OBJ)/sndhrdw/bosco.o $(OBJ)/vidhrdw/bosco_vidhrdw.o \
	...
	$(OBJ)/machine/phozon.o \
	$(OBJ)/machine/mappy.o $(OBJ)/vidhrdw/mappy_vidhrdw.o $(OBJ)/drivers/mappy.o \
	$(OBJ)/machine/grobda.o \
	...
	$(OBJ)/machine/polepos.o $(OBJ)/vidhrdw/polepos_vidhrdw.o $(OBJ)/sndhrdw/polepos.o $(OBJ)/drivers/polepos.o \
...
$(OBJ)/nintendo.a: \
	$(OBJ)/vidhrdw/dkong_vidhrdw.o $(OBJ)/sndhrdw/dkong.o $(OBJ)/drivers/dkong.o \
...
$(OBJ)/midw8080.a: \
	...
	$(OBJ)/vidhrdw/8080bw_vidhrdw.o $(OBJ)/sndhrdw/8080bw_sndhrdw.o $(OBJ)/drivers/8080bw_drivers.o $(OBJ)/drivers/n8080.o \
...
$(OBJ)/cvs.a: \
	$(OBJ)/vidhrdw/s2636_vidhrdw.o $(OBJ)/vidhrdw/cvs_vidhrdw.o $(OBJ)/drivers/cvs.o \
...
$(OBJ)/taito.a: \
	...
	$(OBJ)/machine/chaknpop_machine.o $(OBJ)/vidhrdw/chaknpop.o $(OBJ)/drivers/chaknpop.o \
	$(OBJ)/machine/qix.o $(OBJ)/vidhrdw/qix.o $(OBJ)/drivers/qix.o \
	$(OBJ)/machine/taitosj_machine.o $(OBJ)/vidhrdw/taitosj.o $(OBJ)/drivers/taitosj.o \
	...
	$(OBJ)/machine/retofinv.o $(OBJ)/vidhrdw/retofinv_vidhrdw.o $(OBJ)/drivers/retofinv.o \
	...
	$(OBJ)/machine/mexico86_machine.o $(OBJ)/vidhrdw/mexico86.o $(OBJ)/drivers/mexico86.o \
	...
	$(OBJ)/machine/volfied_machine.o $(OBJ)/vidhrdw/volfied.o $(OBJ)/drivers/volfied.o \
...
$(OBJ)/capcom.a: \
	...
	$(OBJ)/vidhrdw/cps1.o $(OBJ)/drivers/cps1.o $(OBJ)/drivers/cps2.o $(OBJ)/machine/cps2crypt.o \
...
$(OBJ)/sega.a: \
	...
	$(OBJ)/vidhrdw/zaxxon_vidhrdw.o $(OBJ)/sndhrdw/zaxxon.o $(OBJ)/drivers/zaxxon.o \
	$(OBJ)/drivers/congo.o \
	...
	$(OBJ)/machine/system16_machine.o $(OBJ)/machine/fd1089.o $(OBJ)/machine/mc8123.o $(OBJ)/vidhrdw/segas18.o $(OBJ)/drivers/system18.o $(OBJ)/vidhrdw/resnet.o $(OBJ)/vidhrdw/system16_vidhrdw.o $(OBJ)/vidhrdw/sys16spr.o \
	$(OBJ)/sndhrdw/system16.o \
	$(OBJ)/drivers/system16.o $(OBJ)/drivers/aburner.o \
	$(OBJ)/drivers/sharrier.o \
	$(OBJ)/drivers/system24.o $(OBJ)/machine/system24.o $(OBJ)/vidhrdw/system24_vidhrdw.o \
	$(OBJ)/vidhrdw/segaic24.o \
	$(OBJ)/drivers/system32.o $(OBJ)/vidhrdw/system32.o $(OBJ)/drivers/multi32.o \
...
$(OBJ)/atari.a: \
	...
	$(OBJ)/machine/asteroid_machine.o $(OBJ)/sndhrdw/asteroid.o \
	...
	$(OBJ)/machine/videopin.o $(OBJ)/vidhrdw/videopin_vidhrdw.o $(OBJ)/drivers/videopin.o \
	...
	$(OBJ)/vidhrdw/atarimo.o $(OBJ)/vidhrdw/atarirle_vidhrdw.o \
	...
	$(OBJ)/machine/harddriv_machine.o $(OBJ)/vidhrdw/harddriv.o $(OBJ)/sndhrdw/harddriv.o $(OBJ)/drivers/harddriv.o \
...
$(OBJ)/tms.a: \
	...
	$(OBJ)/machine/midyunit_machine.o $(OBJ)/vidhrdw/midyunit.o $(OBJ)/drivers/midyunit.o \
	$(OBJ)/drivers/midxunit.o \
	$(OBJ)/machine/midwunit_machine.o $(OBJ)/drivers/midwunit.o \
	$(OBJ)/vidhrdw/midvunit.o $(OBJ)/drivers/midvunit.o \
	$(OBJ)/machine/midtunit_machine.o $(OBJ)/vidhrdw/midtunit.o $(OBJ)/drivers/midtunit.o \
...
# Phase 2: driver families not previously compiled.
$(OBJ)/other.a: \
	$(OBJ)/vidhrdw/snes_vidhrdw.o \
	$(OBJ)/machine/snes_machine.o $(OBJ)/drivers/stvhacks.o \
	$(OBJ)/machine/stvcd.o $(OBJ)/machine/am53cf96.o $(OBJ)/machine/scudsp.o \
	$(OBJ)/machine/psx_machine.o $(OBJ)/vidhrdw/psx_vidhrdw.o $(OBJ)/machine/segaic16.o \
	$(OBJ)/vidhrdw/segaic16.o $(OBJ)/sndhrdw/snes_sndhrdw.o $(OBJ)/vidhrdw/stvvdp1_vidhrdw.o \
	$(OBJ)/vidhrdw/stvvdp2_vidhrdw.o $(OBJ)/vidhrdw/voodoo_vidhrdw.o \
	$(OBJ)/drivers/1945kiii.o $(OBJ)/drivers/ashnojoe.o $(OBJ)/vidhrdw/ashnojoe_vidhrdw.o \
	$(OBJ)/drivers/backfire.o $(OBJ)/drivers/bishi.o $(OBJ)/vidhrdw/bishi_vidhrdw.o $(OBJ)/drivers/calorie.o \
	$(OBJ)/drivers/compgolf.o $(OBJ)/vidhrdw/compgolf_vidhrdw.o $(OBJ)/drivers/crospang.o $(OBJ)/vidhrdw/crospang_vidhrdw.o \
	$(OBJ)/drivers/darkmist.o $(OBJ)/vidhrdw/darkmist_vidhrdw.o $(OBJ)/drivers/dblewing.o $(OBJ)/drivers/deco156.o \
	$(OBJ)/vidhrdw/deco_mlc_vidhrdw.o $(OBJ)/drivers/djmain.o $(OBJ)/vidhrdw/djmain_vidhrdw.o \
	$(OBJ)/drivers/dorachan.o $(OBJ)/vidhrdw/dorachan_vidhrdw.o $(OBJ)/drivers/embargo.o $(OBJ)/drivers/funybubl.o \
	$(OBJ)/drivers/goal92.o $(OBJ)/vidhrdw/goal92_vidhrdw.o $(OBJ)/drivers/homerun.o $(OBJ)/vidhrdw/homerun_vidhrdw.o \
	$(OBJ)/drivers/inufuku.o $(OBJ)/vidhrdw/inufuku_vidhrdw.o $(OBJ)/drivers/jchan.o $(OBJ)/drivers/jcross.o \
	$(OBJ)/vidhrdw/jcross_vidhrdw.o $(OBJ)/drivers/jollyjgr.o $(OBJ)/drivers/konamigq.o $(OBJ)/drivers/konamigx.o \
	$(OBJ)/vidhrdw/konamigx_vidhrdw.o $(OBJ)/machine/konamigx_machine.o $(OBJ)/drivers/ladyfrog.o $(OBJ)/vidhrdw/ladyfrog_vidhrdw.o \
	$(OBJ)/drivers/lethal.o $(OBJ)/vidhrdw/lethal_vidhrdw.o $(OBJ)/drivers/madalien.o $(OBJ)/drivers/malzak.o \
	$(OBJ)/vidhrdw/malzak_vidhrdw.o $(OBJ)/drivers/marinedt.o $(OBJ)/drivers/mirax.o $(OBJ)/drivers/model1.o \
	$(OBJ)/vidhrdw/model1_vidhrdw.o $(OBJ)/machine/model1_machine.o $(OBJ)/drivers/mogura.o $(OBJ)/drivers/mwarr.o \
	$(OBJ)/drivers/mystwarr.o $(OBJ)/vidhrdw/mystwarr_vidhrdw.o $(OBJ)/drivers/namcos10.o \
	$(OBJ)/drivers/namcos11.o $(OBJ)/drivers/namcos12.o $(OBJ)/drivers/nss.o $(OBJ)/drivers/outrun.o \
	$(OBJ)/drivers/pturn.o $(OBJ)/drivers/quizpani.o $(OBJ)/vidhrdw/quizpani_vidhrdw.o $(OBJ)/drivers/rabbit.o \
	$(OBJ)/drivers/runaway.o $(OBJ)/vidhrdw/runaway_vidhrdw.o $(OBJ)/drivers/seattle.o \
	$(OBJ)/drivers/segaxbd.o $(OBJ)/vidhrdw/segaxbd.o \
	$(OBJ)/drivers/speedatk.o $(OBJ)/vidhrdw/speedatk_vidhrdw.o $(OBJ)/drivers/sprint8.o $(OBJ)/vidhrdw/sprint8_vidhrdw.o \
	$(OBJ)/drivers/sspeedr.o $(OBJ)/vidhrdw/sspeedr_vidhrdw.o $(OBJ)/drivers/strvmstr.o $(OBJ)/drivers/stv.o \
	$(OBJ)/drivers/supertnk.o $(OBJ)/drivers/suprridr.o $(OBJ)/vidhrdw/suprridr_vidhrdw.o \
	$(OBJ)/drivers/tatsumi.o $(OBJ)/vidhrdw/tatsumi.o $(OBJ)/machine/tatsumi.o $(OBJ)/drivers/tceptor.o \
	$(OBJ)/vidhrdw/tceptor_vidhrdw.o $(OBJ)/drivers/tryout.o $(OBJ)/vidhrdw/tryout_vidhrdw.o $(OBJ)/drivers/vamphalf.o \
	$(OBJ)/drivers/vmetal.o $(OBJ)/drivers/yumefuda.o $(OBJ)/drivers/zn.o \
	$(OBJ)/sndhrdw/ataridis_sndhrdw.o \
	$(OBJ)/vidhrdw/kopunch_vidhrdw.o $(OBJ)/vidhrdw/mainsnk_vidhrdw.o $(OBJ)/machine/namcoio_machine.o $(OBJ)/machine/strtheat.o $(OBJ)/machine/opwolf_machine.o $(OBJ)/sndhrdw/triplhnt.o $(OBJ)/sndhrdw/t5182.o $(OBJ)/sndhrdw/cage_sndhrdw.o \
	...
	$(OBJ)/vidhrdw/redalert_vidhrdw.o $(OBJ)/sndhrdw/redalert.o $(OBJ)/drivers/redalert.o \
	...
	$(OBJ)/vidhrdw/flower_vidhrdw.o $(OBJ)/sndhrdw/flower.o $(OBJ)/drivers/flower.o \
